...
export class MapTransactionIndexToTransactionMetadata {
  static __wrap(ptr) {
    const obj = Object.create(
      MapTransactionIndexToTransactionMetadata.prototype
    )
    obj.ptr = ptr
  ...
  insert(key, value) {
    ...
    var ret = wasm.maptransactionindextotransactionmetadata_insert(
      this.ptr,
      key,
      value.ptr
    )
...
export const __wbg_getRandomValues_1ef11e888e5228e9 = function (
  arg0,
  arg1,
  arg2
) {
...
export const __wbg_randomFillSync_1b52c8482374c55b = function (
  arg0,
  arg1,
  arg2
) {
